...
![Input values used throughout this article](/assets/imgs/fri_input_values.png)
...
![how FRI works in a nutshell](/assets/imgs/fri_prover-efficiency.drawio.png)
...
![an example of how reduction works](/assets/imgs/fri_prover-reudction.drawio.png)
...
![An example of how the values of a layer are determined](/assets/imgs/fri_prover-verification.drawio.png)
...
![an example of FRI attack](/assets/imgs/fri_prover-attack.drawio.png)
...
![how it works when taking few queries](/assets/imgs/fri_prover-num_query.drawio.png)

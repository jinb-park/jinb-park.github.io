...
\begin{minipage}[t]{0.7\textwidth}
    ...
    \\
    Affiliation: \href{https://www.fairphone.com/}{Fairphone}
    \\
    Website: \href{\PersonalWebsite}{https://jinb-park.github.io}
    \\
    Blog: \href{https://jinb-park.github.io/blog}{https://jinb-park.github.io/blog}
    \\
...
\begin{itemize}
  \item Trusted execution environments (TrustZone, ARM CCA, Intel TDX, Secure processors)
...
\begin{EntriesTable}
  \Duration{2026.08}{Present} &
  \Appointment{Fairphone}{Product Security Officer}{Amsterdam, Netherlands}{}
  \\
  \Duration{2026.01}{2026.06} &
  \Appointment{Samsung Research}{Principal Engineer}{Seoul, South Korea}{}
  \\
  \Duration{2019}{2025} &
  \Appointment{Samsung Research}{Staff Engineer}{Seoul, South Korea}{}
  \\
  \Duration{2016}{2018} &
  \Appointment{Samsung Research}{Senior Engineer}{Seoul, South Korea}{}
  \\
  \Duration{2013}{2015} &
  \Appointment{Samsung Research}{Engineer}{Seoul, South Korea}{}
\end{EntriesTable}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{EntriesTable}
  \Duration{2025.01}{2026.06}  &
  \textbf{A secure AI platform}
  \begin{itemize}
    \item \textbf{Role.} Tech lead (7 engineers involved, 2025.01--2025.12) and Part lead (18 engineers involved, 2025.12--2026.06)
    \item \textbf{Type.} Open source project (it's going to become publicly available in the future)
    \item Private information
    \item Developed a security-focused Linux OS to run modern AI workloads
  \end{itemize}
  \\
  \Duration{2023.05}{2024.12}  &
...
\begin{EntriesTable}
  \Year{2025} &
  A Security Monitor Framework For On-Device Confidential Computing \Slides{https://drive.google.com/file/d/1eDtC00DiEhgcRQJlHUgPdlNHOiNWHEjl/view?usp=share_link} \Video{https://content-cdn.sessionboard.com/event-files/tJzfTYdlT1SMLqCw9NzX_Edgeshield_Video.mp4}
  \begin{itemize}
    \item \textbf{Jinbum Park}
    \item Confidential Computing Summit 2025
  \end{itemize}
  \\
  \Year{2024} &
...
\begin{itemize}
  ...
  \item Trusted execution environment (TEE) and Confidential computing (CC)
